...
@Component({
  selector: 'app-working-tickets',
  templateUrl: './working-tickets.component.html',
  styleUrls: ['./working-tickets.component.css']
})
export class WorkingTicketsComponent implements OnInit {
    ...
    this.ts.getTickets().subscribe({
      next: (result: any) => {
        ...
        for(var i=0;i<this.tickets.length;i++){
          if(this.tickets[i].status === "in-progress"){
